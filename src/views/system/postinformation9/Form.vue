      ...
      <div class="account-settings-info-main" :class="device">
        <div class="account-settings-info-left">
          ...
          >
            ...
            <a-menu-item key="2">岗位角色</a-menu-item>
            <a-menu-item key="3">个人附件</a-menu-item>
            <a-menu-item key="4">员工履历</a-menu-item>
        ...
        <div class="account-settings-info-right">
          ...
          <s-fileinfo
            ...
            :formId="formId"
          ></s-fileinfo>
          <s-posts v-if="key === '4'" :id="base.person_id"></s-posts>
        </div>
      </div>
    </a-card>
  </div>
...
import SPostrole from "./Postrole";
