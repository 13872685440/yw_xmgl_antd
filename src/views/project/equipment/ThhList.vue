<template>
  <a-spin :spinning="spinning">
    <a-button v-if="!isview && state!='00100002'" type="primary" icon="plus" v-action:SYS_ADMINISTRATOR   @click="$refs.createThh.add('')">新建</a-button>
    <a-table :columns="columns" :dataSource="data" :pagination="false" :loading="spinning" ref="table"></a-table>
    <create-thh ref="createThh" :keyValue="id" type="10" @ok="handleOk"/>
  </a-spin>
</template>
<script>
import createThh from "./modules/CreateThh";
