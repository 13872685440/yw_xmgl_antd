<template>
  <a-spin :spinning="spinning">
    <a-button v-if="!isview && state!='00100002'" type="primary" icon="plus" v-action:SYS_ADMINISTRATOR   @click="$refs.createFkysp.add('')">新建</a-button>
    <a-table :columns="columns" :dataSource="data" :pagination="false" :loading="spinning" ref="table"></a-table>
    <create-fkysp ref="createFkysp" :keyValue="id" type="8" @ok="handleOk"/>
  </a-spin>
</template>
<script>
import createFkysp from "./modules/CreateFkysp";
