<template>
  <a-spin :spinning="spinning">
    <a-button v-if="!isview && state!='00100002'" type="primary" icon="plus" v-action:SYS_ADMINISTRATOR   @click="$refs.createSh.add('')">新建</a-button>
    <a-table :columns="columns" :dataSource="data" :pagination="false" :loading="spinning" ref="table"></a-table>
    <create-sh ref="createSh" :keyValue="id" type="9" @ok="handleOk"/>
  </a-spin>
</template>
<script>
import createSh from "./modules/CreateSh";
