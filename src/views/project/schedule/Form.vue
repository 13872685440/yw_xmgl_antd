    ...
    <a-card :bordered="false" :bodyStyle="{ padding: '16px 0', height: '100%' }" :style="{ height: '100%' }" >
      <div class="account-settings-info-main" :class="device">
        ...
        <div class="account-settings-info-right">
          <s-base v-if="key === '1'" :base="base" :SOURCE="SOURCE" :formId="formId" :isview="false" @changeForm="changeForm"></s-base>
          <s-gdjllist v-if="key === '2'" :id="formId" :state="base.gdjlState_code" @changeForm="changeForm"></s-gdjllist>
          <s-zcbjlist v-if="key === '3'" :id="formId" :state="base.zsbjState_code" @changeForm="changeForm" ></s-zcbjlist>
          <s-cbzjlist v-if="key === '4'" :id="formId" :state="base.cbzjState_code" @changeForm="changeForm" ></s-cbzjlist>
        </div>
      </div>
    </a-card>
  </div>
...
export default {
  ...
  async created() {
    ...
    this.path.edit_path = prefix + "/schedule/" + this.type;
