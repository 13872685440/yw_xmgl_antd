    ...
    <a-card :bordered="false" :bodyStyle="{ padding: '16px 0', height: '100%' }" :style="{ height: '100%' }" >
      <div class="account-settings-info-main" :class="device">
        ...
        <div class="account-settings-info-right">
          <s-base-view v-if="key === '1'" :base="base" :type="type" :formId="formId" :XMSTATE="XMSTATE" />
          <s-shwljl-list v-if="key === '2'" :id="formId" :state="base.shlyState_code" :isview="true" />
          <s-skykp-list v-if="key === '3'" :id="formId" :state="base.skykpState_code" :isview="true" />
        </div>
      </div>
    </a-card>
  </div>
...
export default {
  ...
  async created() {
    ...
    this.path.edit_path = prefix + "/aftersales/edit";
    this.selectedKeys = ["1"];
