<template>
  <a-spin :spinning="spinning">
    ...
    <a-button v-if="state!='00100002'" type="primary" icon="plus" v-action:SYS_ADMINISTRATOR   @click="$refs.createKp.add('')">新建</a-button>
    <a-table :columns="columns" :dataSource="data" :pagination="false" :loading="spinning" ref="table"></a-table>
    <create-kp ref="createKp" :keyValue="id"  type="1" @ok="handleOk"/>
  </a-spin>
</template>
<script>

import createKp from "./modules/CreateSk";
